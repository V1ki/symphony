defmodule SymphonyElixir.CoreTest do
  ...
  test "config defaults and validation checks" do
    ...
    assert config.tracker.assignee == System.get_env("TEAMBITION_ASSIGNEE")
  ...
  test "current WORKFLOW.md file is valid and complete" do
    ...
    assert Map.get(hooks, "after_create") =~ "/Users/v1ki/Documents/projs/source/symphony"
    assert Map.get(hooks, "after_create") =~ "AGENT_README.md"
  ...
  test "in-repo WORKFLOW.md renders correctly" do
    ...
    # The status map section depends on the project's actual flow names; we
    # only assert that *some* status-map-like text exists.
